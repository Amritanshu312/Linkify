...
const Input = ({
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className={clsx("flex bg-[linear-gradient(45deg,#0f1632,#0c1227,#0e1530)] border-2 border-[#181f3e] focus-within:border-[#1a2246] p-0.5 w-full items-center gap-2 px-1.5 rounded-md group",
