...
const LoadingLink = ({ totalLen }) => {
  return (
    <>
      {Array.from({ length: totalLen || 8 }).map((i, _) => <div key={_} className={cn(
        "w-full h-full min-h-36 bg-[linear-gradient(#131a33d4,#0c1227d4,#0c132cd4,#0e152ed4)] border-2 border-[#19203c] flex p-3 px-6 rounded-[6px] items-center justify-between gap-4",
      ...
      <div className="w-full h-full min-h-36 bg-[linear-gradient(#131a33d4,#0c1227d4,#0c132cd4,#0e152ed4)] border-2 border-[#19203c] flex p-3 px-6 rounded-[6px] items-center justify-between gap-4 -rotate-1">
        <div className="flex gap-4 items-center w-full">
          <div className="min-w-12 h-12 rounded-full border border-[#242a50] p-2.5">
            <div className="w-full h-full bg-[linear-gradient(#3a2568,#1c1956,#1a244d,#171747)] rounded-full"></div>
          </div>
